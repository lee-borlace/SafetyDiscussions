...
class AddDiscussion extends React.Component {
    ...
    // Main renderer.
    render() {
        return (React.createElement(Button_1.Button, {description: 'Opens the dialog to create a discussion', onClick: this.showDialog.bind(this)}, "Add Safety Discussion")
            ,
